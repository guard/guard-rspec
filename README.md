...
* Compatible with RSpec >= 2.14 (use guard-rspec 1.2.x for older release, including RSpec 1.x)
...
The `:formatter` option has been removed since CLI arguments can be passed through the `:cli` option. If you want to use the former Instafail formatter, you need to use the [rspec-instafail](https://rubygems.org/gems/rspec-instafail) gem instead:
