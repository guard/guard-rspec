...
You can invoke RSpec with any of its standard command line options using the "rspec_options" option:

    guard 'rspec', :rspec_options => "--color --format nested --fail-fast --drb" do
      ...
    end
